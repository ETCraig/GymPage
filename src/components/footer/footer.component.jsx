...
const Footer = () => (
    <footer className="footer bg-dark mt-5" id="footer-styles">
        <div className="container">
            <div className="row">
                <div className="col-lg-6 h-100 text-center text-lg-left my-auto">
                    <ul className="list-inline mb-2">
                        <li className="list-inline-item">
                            <a href="https://www.linkedin.com/in/ethan-craig-93000015a/">About</a>
                        </li>
                        <li className="list-inline-item">&sdot;</li>
                        <li className="list-inline-item">
                            <a href="https://www.linkedin.com/in/ethan-craig-93000015a/">Contact</a>
                        </li>
                    </ul>
